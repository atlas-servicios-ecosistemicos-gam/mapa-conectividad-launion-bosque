---
title: "Mapa de conectividad de grupos funcionales de aves dependientes de bosque en el cantón de La Unión"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos-conectividad/master/launion/bosque/PROBABILIDAD_CONECTIVIDAD_BOSQUE_LA_UNION_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_parches_esenciales_importantes_bosque_la_union/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_rutas_conectividad_bosque_la_union/FeatureServer/0"
...
# Esencialidad
bins_esencialidad <- c(0, 0.002977, 0.016777, 0.059871, 0.458520, Inf)
...
# Importancia
bins_importancia <- c(0, 1417383773920.00, 6234913442510.00, 13116945062300.00, 131632896431000.00, Inf)
